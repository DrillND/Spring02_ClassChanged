...
//		model.addAttribute("serverTime", formattedDate );
	...
	public void demo() {
		...
		Date dateoperation = new java.sql.Date(new java.util.Date().getDate());
		 ...
		 * 
		 * // fetch all customers logger.info("Customers found with findAll():");
		 * logger.info("-------------------------------"); for (Customer customer :
		 * customerRepository.findAll()) { logger.info(customer.toString()); }
		 * logger.info("");
		 * 
		 ...
		 * logger.info("--------------------------------------------");
		 * customerRepository.findByLastName("Bauer").forEach((Customer bauer) -> {
		 * logger.info(bauer.toString()); }); // for (Customer bauer :
